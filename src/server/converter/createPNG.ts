...
export default function createPNG(ctx: any, drawData: PointData[][], totalFrames: number, settings: drawSettings, callback: Function) {
...
function drawFrameRecursively(archive: archiver.Archiver, ctx: any, drawData: PointData[][], frame: number, totalFrames: number, settings: drawSettings, callback: Function) {
